 ...
 */
public class JIBQuartzDecaminutely  implements Job {

    private static final Logger log = LogManager.getLogger(JIBQuartzDecaminutely.class);

    public JIBQuartzDecaminutely() {
